...
<figure>
  <img src="/diagrams/supply-chain-pipeline.svg" alt="Coffee supply chain pipeline: 8 stages from farm delivery to funds distribution, with collateral loan originating at warehousing stage." />
  <figcaption>Full BatchToken lifecycle — eight custody stages from farm to settlement</figcaption>
</figure>
