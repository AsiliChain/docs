---
title: Structural Failures in Uganda’s Coffee Economy
order: 2
label: Structural Failures
description: The five structural failures locking 3.5M farmers out of formal credit and EUDR compliance.
---
...
graph TD
    ...
    style TRAP fill:#7B1D1D,color:#FFFFFF,stroke:#CC0000
```
...
| Mobile money payment | Fonbnk integration |
