...
| Mobile money rail | Fonbnk → MTN Uganda | Fonbnk → Telebirr (confirm Fonbnk Ethiopia coverage) | Fonbnk → M-Pesa Kenya |
...
- **Mobile money:** Telebirr launched 2021, 30M+ users. Fonbnk Ethiopia coverage must be confirmed.
