...
| **Legal production** | UCDA cooperative licence verified on-chain; MAAIF NTS provides legal production status | [UCDA export certification](/overview/export-certification) | ✅ Verified at minting |
