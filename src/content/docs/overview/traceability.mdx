...
| 7 | `EXPORTED` | Shipment confirmed by UCDA export licence | Exporter via dashboard | Export confirmation — included in DDS. **Triggers auto-repayment.** |
...
```
https://trace.asilichain.africa/batch/BATCH-2026-004821
```
