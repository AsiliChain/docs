...
| 7 | `EXPORTED` | Shipment confirmed by Department of Coffee Development export licence | Exporter via dashboard | Export confirmation — included in DDS. **Triggers auto-repayment.** See [Export Certification & Physical Journey](/overview/export-certification) for the full certification and logistics process. |
