...
```bash
curl -X POST https://api.asilichain.africa/farmers/register \
...
```json
{
  ...
  "agent_app_deep_link": "https://agent.asilichain.africa/register/manual?farmer_id=UG-KAS-2024-001234&cooperative_id=COOP-MBALE-001",
