...
```
Production:  https://api.asilichain.africa/v1
Staging:     https://api-staging.asilichain.africa/v1
```
...
```bash
curl -X GET https://api.asilichain.africa/v1/farmers/UG-2024-001234 \
